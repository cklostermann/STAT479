...
funny_grid <- c(0,1,0,0,0,0,0,0)
quick_grid <- c(0,0,1,0,0,0,0,0)
pat_grid <- c(0,0,0,1,0,0,0,0)
celeb_grid <- c(0,0,0,0,1,0,0,0)
danger_grid <- c(0,0,0,0,0,1,0,0)
animals_grid <- c(0,0,0,0,0,0,1,0)
sex_grid <- c(0,0,0,0,0,0,0,1)
