...
hist(1/(1 + exp(-1 * alpha_samples)), breaks=100, main = "Posterior baseline popularity probabilities")
...
hist(pop_prob_prior, main="Prior Predictive Popularity Probability", breaks=100, xlab=expression(pi))
