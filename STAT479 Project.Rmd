...
#hist(1/(1+exp((-1*(alpha+b_funny*1)))))
a <- ad_data$funny==1 & ad_data$show_product_quickly==0 & ad_data$patriotic==0 & ad_data$celebrity==0 &
       ad_data$danger==0 & ad_data$animals==0 & ad_data$use_sex==0
min(na.omit(ad_data$likes[a] / ad_data$popularity[a]))
mean(na.omit(ad_data$likes[a] / ad_data$popularity[a]))
max(na.omit(ad_data$likes[a] / ad_data$popularity[a]))
...
#hist(1/(1+exp((-1*(alpha+b_funny*1)))))
a <- ad_data$funny==0 & ad_data$show_product_quickly==1 & ad_data$patriotic==0 & ad_data$celebrity==0 &
       ad_data$danger==0 & ad_data$animals==0 & ad_data$use_sex==0
min(na.omit(ad_data$likes[a] / ad_data$popularity[a]))
mean(na.omit(ad_data$likes[a] / ad_data$popularity[a]))
max(na.omit(ad_data$likes[a] / ad_data$popularity[a]))
...
#hist(1/(1+exp((-1*(alpha+b_funny*1)))))
a <- ad_data$funny==0 & ad_data$show_product_quickly==0 & ad_data$patriotic==1 & ad_data$celebrity==0 &
       ad_data$danger==0 & ad_data$animals==0 & ad_data$use_sex==0
min(na.omit(ad_data$likes[a] / ad_data$popularity[a]))
mean(na.omit(ad_data$likes[a] / ad_data$popularity[a]))
max(na.omit(ad_data$likes[a] / ad_data$popularity[a]))
...
#hist(1/(1+exp((-1*(alpha+b_funny*1)))))
a <- ad_data$funny==0 & ad_data$show_product_quickly==0 & ad_data$patriotic==0 & ad_data$celebrity==1 &
       ad_data$danger==0 & ad_data$animals==0 & ad_data$use_sex==0
min(na.omit(ad_data$likes[a] / ad_data$popularity[a]))
mean(na.omit(ad_data$likes[a] / ad_data$popularity[a]))
max(na.omit(ad_data$likes[a] / ad_data$popularity[a]))
