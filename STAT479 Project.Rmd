...
#likes for ads 83-123
likes <- c(48000,1700,2100,3400,849,20000,NA,44,319,1000,23,0,37,181,NA,57,434,2,0,74,0,332,19,433,1,159,NA,118,52,80,472,3500,NA,NA,181,34,467,27,0,759)
#dislikes for ads 83-123
dislikes <- c(1354,34,42,141,212,293,NA,3,21,55,32,2,4,11,NA,39,11,0,1,9,0,20,4,33,0,7,NA,2,5,3,17,231,NA,NA,7,1,12,3,0,83)
#views for ads 3-123
views <-c(28794119,524757,1290302,1522475,123759,4934325,NA,14734,112563,116986,11644,845,5877,55292,NA,148193,85038,1341,344,81443,13970,221020,13481,93025,206,43136,NA,88556,
           14259,85531,142876,1455698,NA,NA,31966,30246,29414,2403,641,599128)


#likes for ads 124-244
#c(18,1,677,NA,NA,19000,415,1500,155,1100,8300,17,187,1,26,79,287,278,486,2000,NA,307,8,163,NA,367,30,49,2600,110,1900,101,8,184,NA,NA,94,1000,75,1,38,NA,0,340,41,612,NA,0,595,1300,1200,1,110,4,237,620,184,0,254,187,450,0,39,1300,0,2,NA,32,291,1400,9,2700,1,69,8,167,97000,2,221,217,73,46,3,45,51,2329,36,96,7,0,3,2388,94829,42,10,830,2,436,6,233,NA,404,43,292570,7185,24,30578,3,6,290,163,15,3476,12,253,NA,10,NA,584,15,12,348)
#dislikes for ads 124-244
#c(2,0,10,NA,NA,1400,58,138,13,14,246,1,5,0,3,4,11,18,11,43,NA,11,0,10,NA,15,3,2,368,6,216,7,0,8,NA,NA,5,32,18,0,2,NA,0,17,3,15,NA,0,180,122,58,0,4,1,10,194,11,0,8,15,90,0,1,134,0,1,NA,2,15,224,1,94,0,3,0,15,43000,0,62,7,7,0,0,7,6,84,2,5,0,0,0,40,12797,1,0,26,0,7,1,38,NA,18,1,95204,86,0,598,0,0,7,6,0,166,1,76,NA,1,NA,100,0,4,4)
#views for ads 124-244
#c(27765,400,135771,NA,NA,8055785,556386,583713,93031,119052,1198889,3924,64480,149,24636,18115,61749,132711,62587,406702,NA,176884,610,166562,NA,102223,11735,84392,1425851,35341,645457,46184,1411,104884,NA,NA,51233,239475,11855,133,14334,NA,0,83992,10886,238545,NA,62,731514,1060737,1048484,263,65262,483,179266,267707,35661,7134,68292,31850,95388,26,7346,956693,209,596,NA,26356,179402,359816,2895,310186,49,17292,1709,120470,23650578,213,286130,34966,69692,6682,1025,22909,22067,769358,9646,44129,3505,171,423,500335,7675906,41001,21834,366195,1019,94995,7452,81568,40408,56198,18775,180613401,470295,5225,3982911,1041,1501,35118,112015,4150,1513008,9361,293913,NA,12215,NA,222412,1608,6569,77944)
...
#grids of potential values for each variable ??
funny_grid <- seq(0, 1, by = .001) # create an equally space grid of potential distances for FG attempts
n_grid <- length(x_grid)

#unsure how to specify prior means, variances, and betas
mu_std_alpha <- 1.5
sigma_std_alpha <- 1
mu_std_beta <- -3
sigma_std_beta <- 0.25

#not sure what we all need in this list
ad_list <- list(n = n, y = y, funny = funny, quick = quick, pat = pat, celeb = celeb,
...
logistic_model <- stan_model(file = "logistic_predictor.stan")
```
