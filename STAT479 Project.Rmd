...
funny_grid <- combos$funny1 #grid of possible funny values
quick_grid <- combos$quick1
pat_grid <- combos$pat1
celeb_grid <- combos$celeb1
danger_grid <- combos$danger1
animals_grid <- combos$animals1
sex_grid <- combos$sex1
